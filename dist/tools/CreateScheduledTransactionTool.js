...
export const description = "Creates a scheduled (recurring) transaction with a future date.";
...
export async function execute(input, api) {
    try {
        ...
        const response = await api.scheduledTransactions.createScheduledTransaction(budgetId, { scheduled_transaction: scheduledTransaction });
        return {
            content: [{
                    type: "text",
                    text: JSON.stringify({
